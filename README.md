# tf-aws-module_primitive-cloudwatch_metric_stream
...
Implements a CloudWatch Metric Stream that sends metric data from CloudWatch to a Firehose Delivery Stream. By default, this module will consider all Metrics found in CloudWatch, but providing a list of namespaces via the `metrics_namespaces` parameter will cause only specified namespaces to be sent.
...
| Name | Type |
|------|------|
| [aws_cloudwatch_metric_stream.cloudwatch_metric_stream](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_metric_stream) | resource |
